...
model_name_or_path = MODEL_ZOOS["lmsys/vicuna-7b-v1.5"]
...
config.model = dict(
    ...
    freeze_lm_head=True,
    loss_weight_lm=0.0, # NOTE
    loss_weight_vm=1.0, # NOTE
...
config.data = dict(
    datasets=["laion400m_orig", "blip_laion"],
    size_list=["20M", "10M"],
...
config.training = dict(
    output_dir="./work_dirs/stage1_sdxl_vicuna15_laion400orig20m_creation_only/",
    vit_llrd=False,
    llm_llrd=False,
    ...
    run_name="dreamllmsdxl_stage1_vicuna15_laion400orig20m_creation_only",
