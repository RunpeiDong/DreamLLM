...
__all__ = ["MATH_PROMPT", "SFT_MATH_PROMPT"]
...
r"""If Terrell lifts two 20-pound weights 12 times, he lifts a total of $2\cdot 12\cdot20=480$ pounds of weight.  If he lifts two 15-pound weights instead for $n$ times, he will lift a total of $2\cdot15\cdot n=30n$ pounds of weight.  Equating this to 480 pounds, we can solve for $n$: \begin{align*}
30n&=480\\
...
MATH_PROMPT = fewshot_prompt(BASE_FEWSHOT_TEMPLATE, MATH_EXAMPLES)
SFT_MATH_PROMPT = fewshot_prompt(SFT_FEWSHOT_TEMPLATE, MATH_EXAMPLES)
