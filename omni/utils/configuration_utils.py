...
from omni.utils.hub_utils import extract_commit_hash, http_user_agent
...
class ConfigMixin:
    ...
    def save_config(self, save_directory: str | os.PathLike, **kwargs):
        """
    ...
    @classmethod
    def from_config(cls, config: FrozenDict | dict[str, Any] | None = None, return_unused_kwargs=False, **kwargs):
        r"""
