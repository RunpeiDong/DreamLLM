...
from omni.utils.hub_utils import _get_model_file
from omni.utils.import_utils import is_accelerate_available, is_torch_available
...
def get_model_requires_grad(model: torch.nn.Module | torch.Tensor, *, check_entire: bool = False):
...
def load_state_dict(checkpoint_file: str | os.PathLike):
    """
...
class ModelMixin(torch.nn.Module):
    ...
    def save_pretrained(self, save_directory: str | os.PathLike, is_main_process: bool = True, safe_serialization: bool = True):
        """
